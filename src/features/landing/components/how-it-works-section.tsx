...
function HowItWorksSection() {
	return (
		<section className="bg-background px-5 py-11 text-foreground sm:px-11 sm:py-19">
			<div className="grid grid-cols-1 items-center gap-8 sm:grid-cols-2 sm:gap-17.5">
				<div>
					...
					<p className="mt-4 text-[15px] leading-[1.7] font-light text-pretty text-foreground/60 sm:mt-5 sm:text-base">
						{howItWorksIntro}
					</p>
				</div>
					...
					{howItWorksSteps.map((item, index) => (
						...
						>
							...
							<div>
								...
								<div className="mt-1 text-[13.5px] leading-[1.6] font-light text-foreground/55">
									{item.description}
								</div>
							</div>
						</div>
