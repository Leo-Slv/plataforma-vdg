	...
	return (
		<div className="flex min-h-screen items-center justify-center bg-background px-5 py-11 text-foreground sm:px-6">
			<div className="w-full max-w-[520px] px-6 pt-9 pb-8 sm:px-0">
				...
				<p className="mt-3.5 text-[15px] leading-[1.7] font-light text-pretty text-foreground/55">
				...
				<div className="mt-7.5 rounded-lg border border-foreground/12 bg-surface p-5">
					...
					<div className="mt-4 flex flex-col gap-3 text-[13.5px] font-light">
						<div className="flex justify-between">
							<span className="text-foreground/60">Conta criada</span>
							<span className="text-[oklch(0.75_0.1_248)]">✓ concluído</span>
						</div>
						<div className="flex justify-between">
							<span className="text-foreground/60">E-mail confirmado</span>
							<span
								className={
									confirmed ? 'text-[oklch(0.75_0.1_248)]' : 'text-foreground/40'
								}
							>
						...
						<div className="flex justify-between">
							<span className="text-foreground/60">Acesso às aulas</span>
							<span
								className={
									confirmed ? 'text-[oklch(0.75_0.1_248)]' : 'text-foreground/40'
								}
				...
				<p className="mt-4 text-[12px] leading-[1.6] font-light text-foreground/35">
