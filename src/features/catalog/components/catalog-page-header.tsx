...
function CatalogPageHeader({
	...
	return (
		<div className="px-5 pt-11 pb-2 sm:px-10">
			...
			<p className="mt-3 max-w-[560px] text-[15px] leading-[1.65] font-light text-foreground/50">
			...
			<div className="mt-8 flex flex-wrap items-center gap-2.5">
				<button
					...
					className={cn(
						...
						selectedAreaId === null
							...
							: 'border border-foreground/16 text-foreground/70',
					)}
				>
					Todas as áreas
				</button>
				...
				<input
					...
					className="ml-auto min-w-[200px] border-0 border-b border-foreground/14 bg-transparent py-2 font-sans text-[12.5px] font-light text-foreground outline-none placeholder:text-foreground/45"
				/>
			</div>
		</div>
	);
