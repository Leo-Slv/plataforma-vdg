...
function LessonVideoPanel({
	...
	return (
		<div>
			...
			<div className="rounded-[10px] border border-dashed border-foreground/20 p-5">
				{isLoading ? (
					...
					<div className="flex flex-col gap-3">
						<div>
							<p className="font-sans text-[12px] font-light text-foreground/70">
								Vídeo enviado
							</p>
					...
					<div className="flex flex-col items-center gap-2.5 py-2 text-center">
						<span className="font-sans text-[12px] font-light text-foreground/35">
						...
						{canManage ? (
							...
							<span className="font-sans text-[11.5px] font-light text-foreground/30">
								Requer a permissão de gerenciar vídeos.
							</span>
						)}
					</div>
